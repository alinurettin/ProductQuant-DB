// ProductQuant-DB - Production HTTP Server & OpenMetrics Exporter
...
const PORT = parseInt(process.env.PORT, 10) || 6047;
...
if (require.main === module) {
  startServer(PORT, () => {
    console.log('⚡ ProductQuant-DB active at http://localhost:' + PORT);
  });
}
